...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CodeTextField",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// MARK - 验证码文本框
SWIFT_CLASS("_TtC13CodeTextField13CodeTextField")
@interface CodeTextField : UITextField <UITextFieldDelegate>
/// 文本颜色
